...
$("#container").mouseup(function (e) {
    ...
    if (drawResistance == 1) {
        ...
        if (resistanceNo < 10) {
            ...
            document.getElementById('svgline').appendChild(parseSVG('<polygon id=resistanceBox0' + resistanceNo + ' points="' + rectX1 + ',' + rectY1 + ' ' + rectX2 + ',' + rectY2 + ' ' + rectX3 + ',' + rectY3 + ' ' + rectX4 + ',' + rectY4 + '" style="fill:blue; stroke:lime; stroke-width:1" onclick="derectDelete(this)" onclick="derectDelete(this)"><title>' + ohms + 'Ohms</title></polygon>'));
            ...
            document.getElementById('svgline').appendChild(parseSVG('<polygon id=resistanceBox' + resistanceNo + ' points="' + rectX1 + ',' + rectY1 + ' ' + rectX2 + ',' + rectY2 + ' ' + rectX3 + ',' + rectY3 + ' ' + rectX4 + ',' + rectY4 + '" style="fill:blue; stroke:lime; ;stroke-width:1" onclick="derectDelete(this)"  onclick="derectDelete(this)"><title>' + ohms + 'Ohms</title></polygon>'));
    ...
    if (drawInductance == 1) {
        ...
        if (inductanceNo < 10) {
            ...
            document.getElementById('svgline').appendChild(parseSVG('<polygon id=inductanceBox0' + inductanceNo + ' points="' + rectX1 + ',' + rectY1 + ' ' + rectX2 + ',' + rectY2 + ' ' + rectX3 + ',' + rectY3 + ' ' + rectX4 + ',' + rectY4 + '" style="fill:rgb(255,215,0); stroke:black; ;stroke-width:1" onclick="derectDelete(this)"  onclick="derectDelete(this)"><title>' + henry + 'Henry</title></polygon>'));
            ...
            document.getElementById('svgline').appendChild(parseSVG('<polygon id=inductanceBox' + inductanceNo + ' points="' + rectX1 + ',' + rectY1 + ' ' + rectX2 + ',' + rectY2 + ' ' + rectX3 + ',' + rectY3 + ' ' + rectX4 + ',' + rectY4 + '" style="fill:rgb(255,215,0); stroke:black; ;stroke-width:1" onclick="derectDelete(this)"  onclick="derectDelete(this)"><title>' + henry + 'Henry</title></polygon>'));
    ...
    if (drawCapacitance) {
        ...
        if (capacitanceNo < 10) {
            ...
            document.getElementById('svgline').appendChild(parseSVG('<polygon id=capacitanceBox0' + capacitanceNo + ' points="' + rectX1 + ',' + rectY1 + ' ' + rectX2 + ',' + rectY2 + ' ' + rectX3 + ',' + rectY3 + ' ' + rectX4 + ',' + rectY4 + '" style="fill:rgb(255,0,0); stroke:black; ;stroke-width:1" onclick="derectDelete(this)"  onclick="derectDelete(this)"><title>' + ufarad * 1e6 + 'uFarad</title></polygon>'));
            ...
            document.getElementById('svgline').appendChild(parseSVG('<polygon id=capacitanceBox' + capacitanceNo + ' points="' + rectX1 + ',' + rectY1 + ' ' + rectX2 + ',' + rectY2 + ' ' + rectX3 + ',' + rectY3 + ' ' + rectX4 + ',' + rectY4 + '" style="fill:rgb(255,0,0); stroke:black; ;stroke-width:1" onclick="derectDelete(this)"  onclick="derectDelete(this)"><title>' + ufarad * 1e6 + 'uFarad</title></polygon>'));

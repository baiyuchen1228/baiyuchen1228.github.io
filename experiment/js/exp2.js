				...
				.appendChild(
					parseSVG(
						'<polygon id=resistanceBox0' +
							...
							',' +
							rectY4 +
							'" style="fill:blue; stroke:lime; stroke-width:1" onclick="derectDelete(this)" onclick="derectDelete(this)"><title>' +
							ohms +
							'Ohms</title></polygon>'
					)
				);
				...
				.appendChild(
					parseSVG(
						'<polygon id=inductanceBox0' +
							...
							',' +
							rectY4 +
							'" style="fill:rgb(255,215,0); stroke:black; ;stroke-width:1" onclick="derectDelete(this)"  onclick="derectDelete(this)"><title>' +
							henry +
							'Henry</title></polygon>'
					)
				);
				...
				.appendChild(
					parseSVG(
						'<polygon id=capacitanceBox0' +
							...
							',' +
							rectY4 +
							'" style="fill:rgb(255,0,0); stroke:black; ;stroke-width:1" onclick="derectDelete(this)"  onclick="derectDelete(this)"><title>' +
							ufarad * 1e6 +

...
(function (e, t) {
	function i(t, n) {
		...
		return 'area' === u
			? ((r = t.parentNode),
				(i = r.name),
				!t.href || !i || r.nodeName.toLowerCase() !== 'map' ? !1 : ((o = e('img[usemap=#' + i + ']')[0]), !!o && s(o)))
						...
						? (t = this.parents()
								.filter(function () {
									return (
										...
										/(auto|scroll)/.test(e.css(this, 'overflow') + e.css(this, 'overflow-y') + e.css(this, 'overflow-x'))
									);
								})
								.eq(0))
						: (t = this.parents()
				...
				return (
					...
					u
						? this.each(function () {
								...
								if (!i)
									return e.error(
										'cannot call methods on ' + n + ' prior to initialization; ' + "attempted to call method '" + o + "'"
									);
					...
					e.hide().animate(i, {
						...
						step: function (e, n) {
							(n.now = Math.round(e)),
								n.prop !== 'height'
									? (f += n.now)
									: a.options.heightStyle !== 'content' && ((n.now = Math.round(s - t.outerHeight() - f)), (f = 0));
						},
					});
			},
				...
				this._on(this.menu.element, {
					...
					menufocus: function (t, n) {
						...
						!1 !== this._trigger('focus', t, { item: r })
							? t.originalEvent && /^key/.test(t.originalEvent.type) && this._value(r.value)
...
(function ($, undefined) {
	...
	$.extend(Datepicker.prototype, {
				...
				switch (e.keyCode) {
					...
					case 33:
						$.datepicker._adjustDate(
							e.target,
							e.ctrlKey ? -$.datepicker._get(t, 'stepBigMonths') : -$.datepicker._get(t, 'stepMonths'),
							'M'
						);
						break;
					case 34:
		...
		_hideDatepicker: function (e) {
			...
			if (this._datepickerShowing) {
				...
				$.effects && ($.effects.effect[n] || $.effects[n])
					...
					: t.dpDiv[n == 'slideDown' ? 'slideUp' : n == 'fadeIn' ? 'fadeOut' : 'hide'](n ? r : null, i),
					n || i(),
					(this._datepickerShowing = !1);
		...
		_selectMonthYear: function (e, t, n) {
			var r = $(e),
				i = this._getInst(r[0]);
			(i['selected' + (n == 'M' ? 'Month' : 'Year')] = i['draw' + (n == 'M' ? 'Month' : 'Year')] =
		...
		parseDate: function (e, t, n) {
			...
			a == -1
				...
				: a < 100 && (a += new Date().getFullYear() - (new Date().getFullYear() % 100) + (a <= r ? 0 : -100));
			if (c > -1) {
				(f = 1), (l = c);
				do {
						...
						switch (e.charAt(h)) {
							...
							case 'o':
								l += a(
									'o',
									Math.round(
										(new Date(t.getFullYear(), t.getMonth(), t.getDate()).getTime() - new Date(t.getFullYear(), 0, 0).getTime()) /
											864e5
									),
									3
								);
			...
			for (var j = 0; j < o[0]; j++) {
				...
				for (var I = 0; I < o[1]; I++) {
					...
					for (var Y = 0; Y < Q; Y++) {
						...
						for (var W = 0; W < 7; W++) {
							...
							(Z +=
								...
								((G.getTime() == q.getTime() && p == e.selectedMonth && e._keyEvent) ||
								...
								(tt && !_
									...
									: ' ' +
										et[1] +
										(G.getTime() == l.getTime() ? ' ' + this._currentClass : '') +
										(G.getTime() == t.getTime() ? ' ui-datepicker-today' : '')) +
								'"' +
					...
					p++,
						...
						(U +=
							'</tbody></table>' +
							(f ? '</div>' + (o[0] > 0 && I == o[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : '') : '')),
						(F += U);
				}
				B += F;
			}
		...
		_generateMonthYearHeader: function (e, t, n, r, i, s, o, u) {
			...
			if (s || !a) h += '<span class="ui-datepicker-month">' + o[t] + '</span>';
				...
				for (var v = 0; v < 12; v++)
					(!p || v >= r.getMonth()) &&
						(!d || v <= i.getMonth()) &&
						(h += '<option value="' + v + '"' + (v == t ? ' selected="selected"' : '') + '>' + u[v] + '</option>');
				h += '</select>';
			}
			l || (c += h + (s || !a || !f ? '&#xa0;' : ''));
			if (!e.yearshtml) {
		...
		($.fn.datepicker = function (e) {
			...
			return typeof e != 'string' || (e != 'isDisabled' && e != 'getDate' && e != 'widget')
				? e == 'option' && arguments.length == 2 && typeof arguments[1] == 'string'
					...
					: this.each(function () {
							typeof e == 'string'
								? $.datepicker['_' + e + 'Datepicker'].apply($.datepicker, [this].concat(t))
	...
	e.widget('ui.draggable', e.ui.mouse, {
		...
		_getParentOffset: function () {
			...
			if (
				...
				(this.offsetParent[0].tagName && this.offsetParent[0].tagName.toLowerCase() == 'html' && e.ui.ie)
			)
				t = { top: 0, left: 0 };
			return {
			...
			if (t.containment == 'document' || t.containment == 'window')
				this.containment = [
					...
					(t.containment == 'document' ? 0 : e(window).scrollTop()) +
						(e(t.containment == 'document' ? document : window).height() || document.body.parentNode.scrollHeight) -
		...
		_convertPositionTo: function (t, n) {
			...
			var r = t == 'absolute' ? 1 : -1,
				i = this.options,
				s =
					this.cssPosition != 'absolute' || (this.scrollParent[0] != document && !!e.contains(this.scrollParent[0], this.offsetParent[0]))
						? this.scrollParent
						: this.offsetParent,
			...
			return {
				top:
					...
					(this.cssPosition == 'fixed' ? -this.scrollParent.scrollTop() : o ? 0 : s.scrollTop()) * r,
				left:
					n.left +
					this.offset.relative.left * r +
					this.offset.parent.left * r -
					(this.cssPosition == 'fixed' ? -this.scrollParent.scrollLeft() : o ? 0 : s.scrollLeft()) * r,
			};
		},
		_generatePosition: function (t) {
			...
			return {
				...
				left:
					...
					(this.cssPosition == 'fixed' ? -this.scrollParent.scrollLeft() : i ? 0 : r.scrollLeft()),
			};
		},
		_clear: function () {
			...
			start: function (t, n) {
				...
				(r.sortables = []),
					e(i.connectToSortable).each(function () {
						...
						n &&
							!n.options.disabled &&
							(r.sortables.push({ instance: n, shouldRevert: n.options.revert }), n.refreshPositions(), n._trigger('activate', t, s));
					});
			},
			stop: function (t, n) {
				var r = e(this).data('draggable'),
						...
						this.instance._intersectsWith(this.instance.containerCache) &&
							...
							e.each(r.sortables, function () {
								return (
									...
									this != u &&
										this.instance._intersectsWith(this.instance.containerCache) &&
										e.ui.contains(u.instance.element[0], this.instance.element[0]) &&
										(o = !1),
									o
								);
							})),
				...
				(r.snapElements = []),
					e(i.snap.constructor != String ? i.snap.items || ':data(draggable)' : i.snap).each(function () {
						var t = e(this),
							n = t.offset();
						this != r.element[0] &&
							r.snapElements.push({ item: this, width: t.outerWidth(), height: t.outerHeight(), top: n.top, left: n.left });
					});
			},
			drag: function (t, n) {
				var r = e(this).data('draggable'),
				...
				for (var l = r.snapElements.length - 1; l >= 0; l--) {
					...
					if (
						...
						r.snapElements[l].snapping &&
							...
							r.options.snap.release.call(r.element, t, e.extend(r._uiHash(), { snapItem: r.snapElements[l].item })),
					...
					if (i.snapMode != 'inner') {
						var v = Math.abs(p - f) <= s,
							...
							y = Math.abs(h - o) <= s;
						v &&
							(n.position.top = r._convertPositionTo('relative', { top: p - r.helperProportions.height, left: 0 }).top - r.margins.top),
							m && (n.position.top = r._convertPositionTo('relative', { top: d, left: 0 }).top - r.margins.top),
							g &&
								(n.position.left =
									r._convertPositionTo('relative', { top: 0, left: c - r.helperProportions.width }).left - r.margins.left),
					...
					if (i.snapMode != 'outer') {
						...
						v && (n.position.top = r._convertPositionTo('relative', { top: p, left: 0 }).top - r.margins.top),
							m &&
								(n.position.top =
									r._convertPositionTo('relative', { top: d - r.helperProportions.height, left: 0 }).top - r.margins.top),
							g && (n.position.left = r._convertPositionTo('relative', { top: 0, left: c }).left - r.margins.left),
							y &&
								(n.position.left =
									r._convertPositionTo('relative', { top: 0, left: h - r.helperProportions.width }).left - r.margins.left);
					}
					!r.snapElements[l].snapping &&
						(v || m || g || y || b) &&
						r.options.snap.snap &&
						r.options.snap.snap.call(r.element, t, e.extend(r._uiHash(), { snapItem: r.snapElements[l].item })),
	...
	e.widget('ui.droppable', {
		...
		_over: function (t) {
			...
			this.accept.call(this.element[0], n.currentItem || n.element) &&
				(this.options.hoverClass && this.element.addClass(this.options.hoverClass), this._trigger('over', t, this.ui(n)));
		},
		_out: function (t) {
			var n = e.ui.ddmanager.current;
			if (!n || (n.currentItem || n.element)[0] == this.element[0]) return;
			this.accept.call(this.element[0], n.currentItem || n.element) &&
				(this.options.hoverClass && this.element.removeClass(this.options.hoverClass), this._trigger('out', t, this.ui(n)));
		},
		_drop: function (t, n) {
				...
				function p(e, t, n) {
					...
					return e == null
						? n || !t.def
							? null
							: t.def
						: ((e = r.floor ? ~~e : parseFloat(e)), isNaN(e) ? t.def : r.mod ? (e + r.mod) % r.mod : 0 > e ? 0 : r.max < e ? r.max : e);
				}
				function d(e) {
					var n = o(),
						r = (n._rgba = []);
						...
						transition: function (e, t) {
							...
							return (
								...
								h(i.props, function (e, r) {
									...
									s === null
										? (l[i] = o)
										: (u.mod && (o - s > u.mod / 2 ? (s += u.mod) : s - o > u.mod / 2 && (s -= u.mod)),
											(l[i] = p((o - s) * t + s, r)));
								}),
								this[r](l)
							);
			...
			(function () {
				...
				e.extend(e.effects, {
					...
					removeWrapper: function (t) {
						...
						return (
							t.parent().is('.ui-effects-wrapper') && (t.parent().replaceWith(t), (t[0] === n || e.contains(t[0], n)) && e(n).focus()),
							t
						);
					},
...
(function (e, t) {
	(e.effects.effect.puff = function (t, n) {
		...
		e.extend(t, {
			...
			complete: n,
			percent: s ? o : 100,
			from: s ? a : { height: a.height * u, width: a.width * u, outerHeight: a.outerHeight * u, outerWidth: a.outerWidth * u },
		}),
			r.effect(t);
	}),
		...
		(e.effects.effect.size = function (t, n) {
			...
			p === 'show' && o.show(),
				...
				t.mode === 'toggle' && p === 'show'
					...
					: ((o.from = t.from || (p === 'show' ? b : r)), (o.to = t.to || (p === 'hide' ? b : r))),
				(s = {
				...
				(c = c.concat(['marginTop', 'marginBottom']).concat(l)),
					...
					o.find('*[width]').each(function () {
						...
						d && e.effects.save(n, f),
							...
							s.from.y !== s.to.y &&
								((n.from = e.effects.setTransition(n, c, s.from.y, n.from)), (n.to = e.effects.setTransition(n, c, s.to.y, n.to))),
							s.from.x !== s.to.x &&
								((n.from = e.effects.setTransition(n, h, s.from.x, n.from)), (n.to = e.effects.setTransition(n, h, s.to.x, n.to))),
							n.css(n.from),
...
(function (e, t) {
	e.widget('ui.resizable', e.ui.mouse, {
		...
		_destroy: function () {
			...
			if (this.elementIsWrapper) {
				...
				this.originalElement
					.css({ position: n.css('position'), width: n.outerWidth(), height: n.outerHeight(), top: n.css('top'), left: n.css('left') })
					.insertAfter(n),
					n.remove();
			}
		...
		_mouseStart: function (t) {
			...
			return (
				e('body').css('cursor', a == 'auto' ? this.axis + '-resize' : a), s.addClass('ui-resizable-resizing'), this._propagate('start', t), !0
			);
		},
		_mouseDrag: function (e) {
			var t = this.helper,
			...
			resize: function (t, n) {
				...
				c[0] != document && /static/.test(c.css('position')) && (l = o),
					a.left < (r._helper ? o.left : 0) &&
						((r.size.width = r.size.width + (r._helper ? r.position.left - o.left : r.position.left - l.left)),
						f && (r.size.height = r.size.width / r.aspectRatio),
						(r.position.left = i.helper ? o.left : 0)),
					a.top < (r._helper ? o.top : 0) &&
						((r.size.height = r.size.height + (r._helper ? r.position.top - o.top : r.position.top)),
				...
				d && v && (h -= r.parentData.left),
					h + r.size.width >= r.parentData.width &&
						((r.size.width = r.parentData.width - h), f && (r.size.height = r.size.width / r.aspectRatio)),
					p + r.size.height >= r.parentData.height &&
						((r.size.height = r.parentData.height - p), f && (r.size.width = r.size.height * r.aspectRatio));
			},
			stop: function (t, n) {
				var r = e(this).data('resizable'),
					i = r.options,
			...
			return (
				...
				this.selectees.each(function () {
					...
					r.tolerance == 'touch'
						...
						: r.tolerance == 'fit' && (f = a.left > i && a.right < o && a.top > s && a.bottom < u),
						f
							? (a.selected && (a.$element.removeClass('ui-selected'), (a.selected = !1)),
								...
								a.selecting ||
									(a.$element.addClass('ui-selecting'), (a.selecting = !0), n._trigger('selecting', t, { selecting: a.element })))
							: (a.selecting &&
			...
			(this._keySliding = !1),
				...
				i.range &&
					...
					(this.range = e('<div></div>')
						...
						.addClass(
							'ui-slider-range ui-widget-header' + (i.range === 'min' || i.range === 'max' ? ' ui-slider-range-' + i.range : '')
						))),
		...
		_refreshValue: function () {
			...
			this.options.values && this.options.values.length
				...
				: ((r = this.value()),
					...
					o === 'max' &&
						this.orientation === 'horizontal' &&
						this.range[f ? 'animate' : 'css']({ width: 100 - n + '%' }, { queue: !1, duration: u.animate }),
...
(function (e, t) {
	e.widget('ui.sortable', e.ui.mouse, {
		...
		_setOption: function (t, n) {
			t === 'disabled'
				? ((this.options[t] = n), this.widget().toggleClass('ui-sortable-disabled', !!n))
				: e.Widget.prototype._setOption.apply(this, arguments);
		},
		...
		_mouseStart: function (t, n, r) {
			...
			(this.currentContainer = this),
				...
				i.opacity &&
					(this.helper.css('opacity') && (this._storedOpacity = this.helper.css('opacity')), this.helper.css('opacity', i.opacity)),
		...
		_mouseDrag: function (t) {
			...
			if (this.options.scroll) {
				...
				this.scrollParent[0] != document && this.scrollParent[0].tagName != 'HTML'
					...
					: (t.pageY - e(document).scrollTop() < n.scrollSensitivity
							...
							: e(window).height() - (t.pageY - e(document).scrollTop()) < n.scrollSensitivity &&
								(r = e(document).scrollTop(e(document).scrollTop() + n.scrollSpeed)),
						t.pageX - e(document).scrollLeft() < n.scrollSensitivity
							? (r = e(document).scrollLeft(e(document).scrollLeft() - n.scrollSpeed))
							: e(window).width() - (t.pageX - e(document).scrollLeft()) < n.scrollSensitivity &&
								(r = e(document).scrollLeft(e(document).scrollLeft() + n.scrollSpeed))),
			...
			for (var i = this.items.length - 1; i >= 0; i--) {
				...
				if (
					...
					(this.options.type == 'semi-dynamic' ? !e.contains(this.element[0], o) : !0)
				) {
						...
						a &&
							...
							r.push([
								e.isFunction(a.options.items)
									...
									: e(a.options.items, a.element).not('.ui-sortable-helper').not('.ui-sortable-placeholder'),
								a,
							]);
					}
				}
		...
		_generatePosition: function (t) {
			...
			if (this.originalPosition) {
				...
				if (n.grid) {
					...
					o = this.containment
						? u - this.offset.click.top < this.containment[1] || u - this.offset.click.top > this.containment[3]
		...
		_rearrange: function (e, t, n, r) {
			n
				...
				: t.item[0].parentNode.insertBefore(this.placeholder[0], this.direction == 'down' ? t.item[0] : t.item[0].nextSibling),
				...
				this.anchors.each(function (n, r) {
					...
					s(r)
						...
						: ((u = t._tabId(f)),
							(i = '#' + u),
							(o = t.element.find(i)),
							o.length || ((o = t._createPanel(u)), o.insertAfter(t.panels[n - 1] || t.tablist)),
				...
				_tabId: function (t) {
					...
					return (
						...
						e(n).closest('li').attr('aria-controls') ||
							(n.title && n.title.replace(/\s/g, '_').replace(/[^\w\u00c0-\uFFFF\-]/g, '')) ||

				...
				.appendChild(
					parseSVG(
						'<polygon id=resistanceBox0' +
							...
							',' +
							rectY4 +
							'" style="fill:blue; stroke:lime; stroke-width:1" onclick="derectDelete(this)"><title>' +
							ohms +
							'Ohms</title></polygon>'
					)
				);
				...
				.appendChild(
					parseSVG(
						'<polygon id=inductanceBox0' +
							...
							',' +
							rectY4 +
							'" style="fill:rgb(255,215,0); stroke:black; stroke-width:1" onclick="derectDelete(this)"><title>' +
							henry +
							'Henry</title></polygon>'
					)
				);
	...
	if (drawCapacitance) {
		...
		if (capacitanceNo < 10) {
			document
				...
				.appendChild(
					parseSVG(
						'<circle id=capacitanceCircle1_0' +
							capacitanceNo +
							' cx=' +
							x1 +
							' cy=' +
			...
			document
				...
				.appendChild(
					parseSVG(
						'<circle id=capacitanceCircle2_0' +
							capacitanceNo +
							' cx=' +
							x2 +
							' cy=' +
				...
				.appendChild(
					parseSVG(
						'<polygon id=capacitanceBox0' +
							...
							',' +
							rectY4 +
							'" style="fill:rgb(255,0,0); stroke:black; stroke-width:1" onclick="derectDelete(this)"><title>' +
							ufarad +
		...
		.appendChild(
			parseSVG(
				'<line dataohm="' +
					...
					' style="stroke:' +
					colorlist[colorNo] +
					';stroke-width:2" onclick="derectDelete(this)"><title>電阻 B</title></line>'
			)
		);
	document
		.getElementById('svgline')
		.appendChild(
			parseSVG(
				'<polygon id=resistanceBox0' +
					...
					',' +
					rectY4 +
					'" style="fill:blue; stroke:lime; stroke-width:1" onclick="derectDelete(this)"><title>電阻 B</title></polygon>'
			)
		);
	findPersistNode();
}

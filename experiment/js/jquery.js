		...
		n.queue ||
			...
			e.nodeType === 1 &&
				...
				v.css(e, 'display') === 'inline' &&
					v.css(e, 'float') === 'none' &&
					(!v.support.inlineBlockNeedsLayout || nn(e.nodeName) === 'inline' ? (p.display = 'inline-block') : (p.zoom = 1))),
			n.overflow &&
				((p.overflow = 'hidden'),
					...
					if (typeof u == 'string')
						if (!gt.test(u)) u = t.createTextNode(u);
							...
							if (!v.support.tbody) {
								(h = mt.test(u)),
									(p =
										a === 'table' && !h ? c.firstChild && c.firstChild.childNodes : f[1] === '<table>' && !h ? c.childNodes : []);
			...
			ajax: function (e, n) {
				...
				d.promise(x),
					...
					c.crossDomain == null &&
						...
						(c.crossDomain = !(
							!a ||
							(a[1] === ln[1] && a[2] === ln[2] && (a[3] || (a[1] === 'http:' ? 80 : 443)) == (ln[3] || (ln[1] === 'http:' ? 80 : 443)))
						))),

...
!(function (t, e) {
	...
	function qt(t) {
		...
		return (
			Array.isArray(t)
				? t.length >= 3 && ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = vt(t[3])))
	...
	function Me(t, e, i, s) {
		...
		(h = Math.max(0, h - o.width)),
			...
			h && !c && (c = ve(h / 2));
		return (
			(void 0 !== e || void 0 !== i) && s && l.height && c > l.height && ((c = l.height), (h = ve(Math.floor(c * s)))), { width: h, height: c }
		);
	}
	function we(t, e, i) {
		const s = e || 1,
				...
				for (i = 0, s = t.length; i < s; ++i)
					(a = o),
						...
						o &&
							...
							r && ((n.cp2x = ri(n.cp2x, e.left, e.right)), (n.cp2y = ri(n.cp2y, e.top, e.bottom))));
			})(t, i);
	}
	const hi = (t) => 0 === t || 1 === t,
			...
			(m = e[t % a]),
				m.skip ||
					...
					p !== b &&
						...
						null !== _ && v() && (g.push(Li({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
						(i = t),
						(b = p)));
			...
			? (function (t, e, i, s) {
					...
					for (const t of e) {
						...
						for (u = d + 1; u <= t.end; u++) {
							const r = i[u % l];
							(e = Fi(
								s.setContext(Di(n, { type: 'segment', p0: o, p1: r, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: a }))
							)),
		...
		for (const r of t) {
			...
			if (r.horizontal) {
				const s = e.w * h,
					o = l.size || t.height;
				w(l.start) && (a = l.start),
					t.fullSize ? ss(t, n.left, a, i.outerWidth - n.right - n.left, o) : ss(t, e.left + l.placed, a, s, o),
					(l.start = a),
					(l.placed += s),
					(a = t.bottom);
			} else {
				const s = e.h * h,
					a = l.size || t.width;
				w(l.start) && (o = l.start),
					t.fullSize ? ss(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : ss(t, o, e.top + l.placed, a, s),
					(l.start = o),
					(l.placed += s),
					(o = t.right);
			}
	...
	class Ks extends Ns {
		...
		update(t, e, i) {
			...
			this._convertTicksToLabels(r ? $s(this.ticks, a) : this.ticks),
				...
				o.display &&
					...
					((this.ticks = Ws(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
		...
		fit() {
			...
			if (o) {
				...
				if (
					(a ? ((t.width = this.maxWidth), (t.height = Us(n) + o)) : ((t.height = this.maxHeight), (t.width = Us(n) + o)),
	...
	class wn {
		...
		constructor(t, i) {
			...
			(this.id = e()),
				...
				(yn[this.id] = this),
				r && l
					? (bt.listen(this, 'complete', bn), bt.listen(this, 'progress', xn), this._initialize(), this.attached && this.update())
		...
		_resize(t, e) {
			...
			(this.width = o.width),
				...
				(this._aspectRatio = this.aspectRatio),
				we(this, a, !0) &&
					(this.notifyPlugins('resize', { size: o }), c(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render());
		}
		ensureScalesHaveIDs() {
		...
		buildOrUpdateControllers() {
			...
			for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
				...
				if (
					...
					Object.assign(e, { dataElementType: Js.getElement(a), datasetElementType: s && Js.getElement(s) }),
		...
		render() {
			!1 !== this.notifyPlugins('beforeRender', { cancelable: !0 }) &&
				(bt.has(this) ? this.attached && !bt.running(this) && bt.start(this) : (this.draw(), bn({ chart: this })));
		}
		draw() {
			let t;
		...
		destroy() {
			...
			this._stop(),
				...
				t && (this.unbindEvents(), Ae(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
				delete yn[this.id],
	...
	function En(t, e, i, s) {
		...
		'middle' === n &&
			i &&
			((t.enableBorderRadius = !0), (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[Rn(c, a, r, l)] = !0), (n = h))),
			(o[Rn(n, a, r, l)] = !0),
			(t.borderSkipped = o);
	}
	function Rn(t, e, i, s) {
						...
						r =
							'flex' === n.barThickness
								...
								: (function (t, e, s, n) {
										...
										let a, r;
										return (
											i(o) ? ((a = e.min * s.categoryPercentage), (r = s.barPercentage)) : ((a = o * n), (r = 1)),
	...
	var oo = Object.freeze({
		...
		PointElement: class extends Ns {
			...
			draw(t, e) {
				...
				this.skip ||
					...
					((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), Te(t, i, this.x, this.y));
			}
			getRange() {
				const t = this.options || {};
		...
		BarElement: class extends Ns {
			...
			draw(t) {
				...
				t.save(),
					(o.w === n.w && o.h === n.h) ||
						(t.beginPath(), a(t, no(o, e, n)), t.clip(), a(t, no(n, -e, o)), (t.fillStyle = i), t.fill('evenodd')),
					t.beginPath(),
					a(t, no(n, e)),
					(t.fillStyle = s),
					t.fill(),
		...
		beforeElementsUpdate: (t, e, s) => {
			...
			t.data.datasets.forEach((e, o) => {
				...
				let { start: d, count: u } = (function (t, e) {
					...
					return (
						l && (n = Z(et(e, o.axis, a).lo, 0, i - 1)), (s = h ? Z(et(e, o.axis, r).hi + 1, n, i) - n : i - n), { start: n, count: s }
					);
				})(l, h);
		...
		s &&
			...
			(function (t, e) {
				...
				t.save(),
					'x' === l &&
						o !== n &&
						(Oo(t, s, a.top), Ao(t, { line: i, target: s, color: n, scale: r, property: l }), t.restore(), t.save(), Oo(t, s, a.bottom));
				...
				for (const t of s) {
					...
					for (const e of h) {
						const s = bo(i, o[e.start], o[e.end], e.loop),
							r = Ei(t, n, s);
						for (const t of r)
							a.push({ source: t, target: e, start: { [i]: _o(l, s, 'start', Math.max) }, end: { [i]: _o(l, s, 'end', Math.min) } });
					}
				}
				return a;
			})(i, s, n);
	...
	class Io extends Ns {
		...
		_draw() {
			...
			(f = b
				? { x: ut(n, this.left + c, this.right - i[0]), y: this.top + c + x, line: 0 }
				: { x: this.left + c, y: ut(n, this.top + x + c, this.bottom - e[0].height), line: 0 }),
			...
			this.legendItems.forEach((y, v) => {
				...
				l.setWidth(this.width),
					b
						...
						: v > 0 &&
							P + _ > this.bottom &&
							((S = f.x = S + e[f.line].width + c), f.line++, (P = f.y = ut(n, this.top + x + c, this.bottom - e[f.line].height)));
				if (
					((function (t, e, i) {
						...
						if (
							...
							const o = e + Math.max((d - p) / 2, 0),
								...
								r = Mi(i.borderRadius);
							s.beginPath(),
								Object.values(r).some((t) => 0 !== t) ? We(s, { x: a, y: o, w: g, h: p, radius: r }) : s.rect(a, o, g, p),
								s.fill(),
								0 !== n && s.stroke();
						}
						s.restore();
		...
		_drawArgs(t) {
			...
			return (
				this.isHorizontal()
					...
					: ('left' === o.position ? ((l = i + t), (h = ut(a, s, e)), (c = -0.5 * D)) : ((l = n - t), (h = ut(a, e, s)), (c = 0.5 * D)),
						(r = s - e)),
	...
	class ea extends Ns {
		...
		getContext() {
			return (
				this.$context ||
				(this.$context =
					((t = this.chart.getContext()), (e = this), (i = this._tooltipItems), Di(t, { tooltip: e, tooltipItems: i, type: 'tooltip' })))
			);
			var t, e, i;
		}
		getTitle(t, e) {
	...
	class ra extends Ks {
		...
		buildTicks() {
			...
			const n = (function (t, e) {
				...
				for (
					b &&
					(u && M !== a ? (s.push({ value: a }), M < a && D++, F(Math.round((M + D * S) * v) / v, a, aa(a, y, t)) && D++) : M < a && D++);
					D < k;
					++D
				)
	...
	class wa extends ra {
		...
		drawBackground() {
			...
			if (t) {
				...
				i.save(),
					i.beginPath(),
					Ma(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length),
					i.closePath(),
					(i.fillStyle = t),
					i.fill(),
					i.restore();
						...
						for (let o = e - 1; o >= 0; o--) {
							...
							if (!i(g)) {
								...
								Object.values(t).some((t) => 0 !== t)
									? (s.beginPath(), We(s, { x: n, y: o, w: a, h: r, radius: t }), s.fill())
									: s.fillRect(n, o, a, r);
							}
	...
	function Da(t, e) {
		...
		return (
			...
			null === l ? null : (a && (l = 'week' !== a || (!N(r) && !0 !== r) ? s.startOf(l, a) : s.startOf(l, 'isoWeek', r)), +l)
		);
	}
	function Ca(t, e, i, s) {
		const n = Sa.length;
			...
			CategoryScale: class extends Ks {
				...
				parse(t, e) {
					...
					return ((t, e) => (null === t ? null : Z(Math.round(t), 0, e)))(
						(e = isFinite(e) && s[e] === t ? e : na(s, t, r(e, t), this._addedLabels)),
						s.length - 1
					);
				}
				determineDataLimits() {

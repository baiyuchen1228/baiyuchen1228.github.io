...
(function (e, t) {
	...
	function Kn(e, t, n) {
		...
		return (
			Jn(f, l), v.isFunction(f.opts.start) && f.opts.start.call(e, f), v.fx.timer(v.extend(a, { anim: f, queue: f.opts.queue, elem: e })), f.progress(f.opts.progress).done(f.opts.done, f.opts.complete).fail(f.opts.fail).always(f.opts.always)
		);
	}
	function Qn(e, t) {
		var n, r, i, s, o;
		...
		v.extend({
			...
			parseHTML: function (e, t, n) {
				...
				return !e || typeof e != 'string'
					? null
					: (typeof t == 'boolean' && ((n = t), (t = 0)), (t = t || i), (r = E.exec(e)) ? [t.createElement(r[1])] : ((r = v.buildFragment([e], t, n ? null : [])), v.merge([], (r.cacheable ? v.clone(r.fragment) : r.fragment).childNodes)));
			},
	...
	(v.event = {
		...
		(function (e, t) {
			...
			var n,
				...
				Z = K(function (e) {
					return (
						(e.innerHTML = "<div class='hidden e'></div><div class='hidden'></div>"), !e.getElementsByClassName || !e.getElementsByClassName('e').length ? !1 : ((e.lastChild.className = 'e'), e.getElementsByClassName('e').length === 2)
					);
				}),
				et = K(function (e) {
		...
		v.each(
			...
			function (e, t) {
				v.fn[e] = function (n, r) {
					...
					return (
						nt.test(e) || (r = n), r && typeof r == 'string' && (i = v.filter(r, i)), (i = this.length > 1 && !ot[e] ? v.unique(i) : i), this.length > 1 && rt.test(e) && (i = i.reverse()), this.pushStack(i, e, l.call(arguments).join(','))
					);
				};
			}
		),
					...
					(o = s = null),
						l.length &&
							v.each(l, function (e, t) {
								t.src ? (v.ajax ? v.ajax({ url: t.src, type: 'GET', dataType: 'script', async: !1, global: !1, throws: !0 }) : v.error('no ajax')) : v.globalEval((t.text || t.textContent || t.innerHTML || '').replace(Tt, '')),

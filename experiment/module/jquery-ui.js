		...
		e.uiBackCompat !== !1 &&
			...
			(function (e, t) {
				...
				t._create = function () {
					var e = this.options;
					e.animate === null &&
						(e.animated ? (e.animated === 'slide' ? (e.animate = 300) : e.animated === 'bounceslide' ? (e.animate = { duration: 200, down: { easing: 'easeOutBounce', duration: 1e3 } }) : (e.animate = e.animated)) : (e.animate = !1)),
						n.call(this);
				};
			})(jQuery, jQuery.ui.accordion.prototype));
})(jQuery);
	...
	$.extend(Datepicker.prototype, {
		...
		_destroyDatepicker: function (e) {
			...
			$.removeData(e, PROP_NAME),
				r == 'input'
					? (n.append.remove(), n.trigger.remove(), t.removeClass(this.markerClassName).unbind('focus', this._showDatepicker).unbind('keydown', this._doKeyDown).unbind('keypress', this._doKeyPress).unbind('keyup', this._doKeyUp))
						...
						f
							...
							: (a.selecting &&
									((t.metaKey || t.ctrlKey) && a.startselected
										...
										: (a.$element.removeClass('ui-selecting'), (a.selecting = !1), a.startselected && (a.$element.addClass('ui-unselecting'), (a.unselecting = !0)), n._trigger('unselecting', t, { unselecting: a.element }))),
								a.selected &&
									!t.metaKey &&
									!t.ctrlKey &&
									!a.startselected &&
...
(function (e, t) {
	e.widget('ui.sortable', e.ui.mouse, {
		...
		_intersectsWith: function (e) {
			...
			return this.options.tolerance == 'pointer' || this.options.forcePointerForContainers || (this.options.tolerance != 'pointer' && this.helperProportions[this.floating ? 'width' : 'height'] > e[this.floating ? 'width' : 'height'])
				? c
		...
		_getItemsAsjQuery: function (t) {
			...
			r.push([
				e.isFunction(this.options.items) ? this.options.items.call(this.element, null, { options: this.options, item: this.currentItem }) : e(this.options.items, this.element).not('.ui-sortable-helper').not('.ui-sortable-placeholder'),
				this,
			]);
		...
		_setContainment: function () {
			...
			if (!/^(document|window|parent)$/.test(t.containment)) {
				...
				this.containment = [
					...
					r.left + (i ? Math.max(n.scrollWidth, n.offsetWidth) : n.offsetWidth) - (parseInt(e(n).css('borderLeftWidth'), 10) || 0) - (parseInt(e(n).css('paddingRight'), 10) || 0) - this.helperProportions.width - this.margins.left,
					r.top + (i ? Math.max(n.scrollHeight, n.offsetHeight) : n.offsetHeight) - (parseInt(e(n).css('borderTopWidth'), 10) || 0) - (parseInt(e(n).css('paddingBottom'), 10) || 0) - this.helperProportions.height - this.margins.top,
				];
			}
		},
		_convertPositionTo: function (t, n) {
		...
		e.uiBackCompat !== !1 &&
			...
			e.widget('ui.tabs', e.ui.tabs, {
				...
				_trigger: function (e, t, n) {
					...
					return s
						? (e === 'beforeActivate'
								? ((r = n.newTab.length ? n.newTab : n.oldTab), (i = n.newPanel.length ? n.newPanel : n.oldPanel), (s = this._super('select', t, { tab: r.find('.ui-tabs-anchor')[0], panel: i[0], index: r.closest('li').index() })))

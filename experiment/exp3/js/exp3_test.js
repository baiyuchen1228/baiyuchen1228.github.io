...
function checkCircuit() {
	alli = getAlligator();
	// console.log(alli);
	const power_pos = { x: -1, y: -1 };
	const power_neg = { x: -1, y: -1 };
	const multer_pos = { x: -1, y: -1 };
	const multer_neg = { x: -1, y: -1 };
	let power1 = { voltage: 'ERR', current: 'ERR' };
	const power2 = { voltage: 0, current: 0 };
	const meter = { voltage: 'ERR' };
...
function checkAns() {
	...
	const ans3 = Number.parseFloat($('#ans3')[0].value);
	// zeroRed

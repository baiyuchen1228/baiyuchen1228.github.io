...
function start() {
	...
	const slope = Math.atan((y2 - y1) / (x2 - x1));
	const rectX1 = centerX - 5 * Math.sin(slope) + 10 * Math.cos(slope);
	const rectY1 = centerY + 5 * Math.cos(slope) + 10 * Math.sin(slope);
	const rectX2 = centerX + 10 * Math.cos(slope) + 5 * Math.sin(slope);
	const rectY2 = centerY + 10 * Math.sin(slope) - 5 * Math.cos(slope);
	const rectX3 = centerX + 5 * Math.sin(slope) - 10 * Math.cos(slope);
	const rectY3 = centerY - 5 * Math.cos(slope) - 10 * Math.sin(slope);
	const rectX4 = centerX - 10 * Math.cos(slope) - 5 * Math.sin(slope);
	const rectY4 = centerY - 10 * Math.sin(slope) + 5 * Math.cos(slope);
